                ...
                <table class="table card-table display mb-4 dataTablesCard " id="example5">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div>
                                        <h6 class="fs-16 text-black font-w600 mb-0 text-nowrap">774748635</h6>
                                        {{-- <span class="sfs-14">Online Shop</span> --}}
                                    </div>
                                </div>
                            </td>
                            <td><span class="text-black">108 Fcfa</span></td>
                            <td><span class="text-black">Abdoulaye Fall</span></td>
                            <td><a href="javascript:void(0)" class="btn btn-success "><strong style="color: black">Réussi</strong></a></td>
                            <td><span class="text-black">Dêpot Orange Money</span></td>
                            <td><span class="text-black">Principal</span></td>
                        ...
                        <tr>
                            ...
                            <td><span class="text-black">108 Fcfa</span></td>
                            <td><span class="text-black">Abdoulaye Fall</span></td>
                            <td><a href="javascript:void(0)" class="btn btn-danger"><strong style="color: black">Echoué</strong></a></td>
                            <td><span class="text-black">Dêpot Orange Money</span></td>
                            <td><span class="text-black">Principal</span></td>
                            <td><span class="text-black">2021-05-08 12:10:13</span></td>
                            <td>
