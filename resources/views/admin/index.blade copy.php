                                ...
                                <div id="accordion-one" class="accordion style-1">
                                        ...
                                        <div class="accordion-header collapsed" data-bs-toggle="collapse" data-bs-target="#default_collapseOne1">
                                            <div class="d-flex align-items-center">
                                                <div class="profile-image">
                                                    <img src="{{asset('assets/backoffice/images/avatar/1.jpg')}}" alt="">
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header" data-bs-toggle="collapse" data-bs-target="#default_collapseOne2">
                                            <div class="d-flex align-items-center">
                                                <div class="profile-image">
                                                    <img src="{{asset('assets/backoffice/images/avatar/2.jpg')}}" alt="">
                                                    <span class="bg-success">
                                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header collapsed" data-bs-toggle="collapse" data-bs-target="#default_collapseOne3">
                                            <div class="d-flex align-items-center">
                                                <div class="profile-image">
                                                    <img src="{{asset('assets/backoffice/images/avatar/3.jpg')}}" alt="">
                                                    <span class="bg-success">
                                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header collapsed" data-bs-toggle="collapse" data-bs-target="#default_collapseOne4">
                                            <div class="d-flex align-items-center">
                                                <div class="profile-image">
                                                    <img src="{{asset('assets/backoffice/images/avatar/4.jpg')}}" alt="">
                                                    <span class="bg-success">
                                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header collapsed" data-bs-toggle="collapse" data-bs-target="#default_collapseOne5">
                                            <div class="d-flex align-items-center">
                                                <div class="profile-image">
                                                    <img src="{{asset('assets/backoffice/images/avatar/5.jpg')}}" alt="">
                                                    <span class="bg-success">
                                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <div class="invoice-list">
                                <img src="{{asset('assets/backoffice/images/avatar/1.jpg')}}" alt="" class="rounded-circle me-3">
                                <div class="me-auto">
                            ...
                            <div class="invoice-list">
                                <img src="{{asset('assets/backoffice/images/avatar/2.jpg')}}" alt="" class="rounded-circle me-3">
                                <div class="me-auto">
                                    <h6 class="fs-16 font-w600 mb-0"><a href="page-invoices.html" class="text-black">FSoziety</a></h6>
                                    <span class="fs-12">4h ago</span>
                                </div>
                            ...
                            <div class="invoice-list">
                                <img src="{{asset('assets/backoffice/images/avatar/3.jpg')}}" alt="" class="rounded-circle me-3">
                                <div class="me-auto">
                                    <h6 class="fs-16 font-w600 mb-0"><a href="page-invoices.html" class="text-black">FSoziety</a></h6>
                                    <span class="fs-12">4h ago</span>
                                </div>
                            ...
                            <div class="invoice-list">
                                <img src="{{asset('assets/backoffice/images/avatar/4.jpg')}}" alt="" class="rounded-circle me-3">
                                <div class="me-auto">
                                    <h6 class="fs-16 font-w600 mb-0"><a href="page-invoices.html" class="text-black">FSoziety</a></h6>
                                    <span class="fs-12">4h ago</span>
                                </div>
                            ...
                            <div class="invoice-list">
                                <img src="{{asset('assets/backoffice/images/avatar/5.jpg')}}" alt="" class="rounded-circle me-3">
                                <div class="me-auto">
                                    <h6 class="fs-16 font-w600 mb-0"><a href="page-invoices.html" class="text-black">FSoziety</a></h6>
                                    <span class="fs-12">4h ago</span>
                                </div>
